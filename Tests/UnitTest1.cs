...
public class Tests
{
    ...
    private readonly IConfigurationRoot _config = new ConfigurationBuilder()
        .AddJsonFile("C:/ТиОПО/Lw9/ApiTestingLW9/Tests/testobjects.json").Build();
    ...
    public void Should_Successfully_Add_Product()
    {
        ...
        Assert.That(createdProduct.alias.ToUpperInvariant() == createdProduct.title.ToUpperInvariant(), "Алиас продукта отличается от тайтла");
